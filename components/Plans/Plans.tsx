...
export default async function Plans() {
  ...
  return (
    <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 flex flex-col items-center space-y-4">
      <h1 className="text-4xl opacity-65">Donate</h1>
      <p className="text-xl opacity-50 max-w-2xl text-center">
      ...
      <div className={cn("grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8 pt-12", gridCols)}>
